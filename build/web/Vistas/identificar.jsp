<%-- 
    ...
    Created on : 30/09/2023, 09:05:28 AM
    Author     : JUAN DAVID
--%>
  ...
  <div class="login-box-body">
    ...
    <form action="srvUsuario?accion=verificar" method="POST">
      <div class="form-group has-feedback">
          <input type="text" name="txtUsu" id="txtUsu" value="" class="formulario__input"  placeholder="Usuario">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
          <input type="password" name="txtPass" id="txtPass" value="" class="formulario__input" placeholder="******">
